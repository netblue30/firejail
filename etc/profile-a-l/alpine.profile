...
mkfile ${HOME}/.addressbook
mkfile ${HOME}/.pine-crash
#mkfile ${HOME}/.pine-debug1
#mkfile ${HOME}/.pine-debug2
#mkfile ${HOME}/.pine-debug3
#mkfile ${HOME}/.pine-debug4
mkfile ${HOME}/.pine-interrupted-mail
mkfile ${HOME}/.pinerc
mkfile ${HOME}/.pinercex
whitelist ${DOCUMENTS}
whitelist ${DOWNLOADS}
