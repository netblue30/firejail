...
*Note:
This is the long term support (LTS) version of Firejail. For the regular version please go to http://github.com/netblue30/firejail.
LTS version is usually supported for two years, at which point it is updated to the latest regular version. The code base is
aprox. 40% smaller than the regular version, providing a smaller attack surface for the SUID executable.
It is more suitable for business environments.*
