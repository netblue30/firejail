...
"$CURL" --no-progress-meter "$BASE_URL"/arch/s390/kernel/syscalls/syscall.tbl -o "$TEMP_DIR"/syscall_s390_64.tbl
echo "✔ File received: syscall_s390_64.tbl"
...
extract_and_install "syscall_s390_64.tbl" "common"
