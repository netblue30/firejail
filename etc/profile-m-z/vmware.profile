...
#disable-mnt
private-etc alsa,asound.conf,ca-certificates,conf.d,crypto-policies,dconf,fonts,gtk-2.0,gtk-3.0,hostname,hosts,ld.so.cache,localtime,machine-id,pulse,pki,resolv.conf,ssl,vmware,vmware-installer,vmware-vix,X11
